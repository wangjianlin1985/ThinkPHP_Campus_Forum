...
Source Database       : luntan_db

Target Server Type    : MYSQL
Target Server Version : 50051
File Encoding         : 65001

Date: 2019-03-29 17:18:03
*/
...
-- Records of t_notice
-- ----------------------------
INSERT INTO `t_notice` VALUES ('1', 'php在线论坛网站成立了', '<p>同学们喜欢讨论什么话题可以来这里交流哦！</p>', '2019-03-30 21:39:55');
...
-- ----------------------------
INSERT INTO `t_postinfo` VALUES ('1', '我想参加社团找谁？', '<p>我喜欢乒乓球，怎么没看到乒乓球的呢？</p>', '58', 'user1', '2019-03-30 21:39:09');
INSERT INTO `t_postinfo` VALUES ('2', '我喜欢打篮球有人和我一样吗', '<p>喜欢打篮球的同学，咱们周末一起去切磋下吧</p>', '10', 'user1', '2019-03-30 \r\n\r\n22:04');
...
-- Records of t_reply
-- ----------------------------
INSERT INTO `t_reply` VALUES ('1', '1', '问管理员吧！', 'user1', '2019-03-30 21:39:21');
INSERT INTO `t_reply` VALUES ('2', '2', '有人和我爱好一样的吗？', 'user1', '2019-03-30 22:27:35');
INSERT INTO `t_reply` VALUES ('3', '1', '我问了管理员，他说马上发布乒乓球社团呢！', 'user2', '2019-03-30 22:44:25');
...
-- ----------------------------
INSERT INTO `t_shenqing` VALUES ('1', '1', 'user1', '2019-03-29 21:38:19', '审核通过', '可以入团');
INSERT INTO `t_shenqing` VALUES ('4', '1', 'user2', '2019-03-30 22:43:40', ' 待审核', '--');
...
-- ----------------------------
INSERT INTO `t_shetuan` VALUES ('1', '羽毛球社团', 'upload/eb4948adb59acfb204684701b2bb5cba.jpg', '1', '2018-12-27', '<p>本羽毛球社团成立于2018年，参\r\n\r\n加了多场著名的国际比赛，还取得了不错的名次</p>', '王羲之', '13305830843');
INSERT INTO `t_shetuan` VALUES ('2', '书法社团', 'upload/848a22661840d326d313504edcb3dfce.jpg', '2', '2019-03-22', '<p>大家一起来玩转中国书法，写出一\r\n\r\n手漂亮的好字</p>', '张国庆', '028-83940843');
...
-- ----------------------------
INSERT INTO `t_userinfo` VALUES ('user1', '123', '张晓芬', '女', '2019-03-07', 'upload/db51ad0c6608c0302031738d3472a0a2.jpg', '13985008435', 'xiaofen@163.com', '四川成都红星路12号', '2019-03-30 21:31:26');
INSERT INTO `t_userinfo` VALUES ('user2', '123', '李小倩', '女', '2019-03-15', 'upload/f0c8b64696ffed18c8bc8ae0e134c885.jpg', '13085340842', 'xiaoqian@163.com', '四川南充冰江路aa', '2019-03-30 22:39:06');
